    ...
    <footer id="contato" className="bg-primary text-primary-foreground">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Sobre */}
          <div>
            <h3 className="font-serif text-2xl font-bold mb-4">Janice Correia</h3>
            <p className="text-primary-foreground/80 mb-4">
              Especialista em comunicação corporativa e oratória, ajudando profissionais e empresas a alcançarem resultados extraordinários.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                <Mail size={18} />
                <a href="mailto:contato@janicecorreia.com.br" className="text-primary-foreground/80 hover:text-primary-foreground">
                  contato@janicecorreia.com.br
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Phone size={18} />
                <a href="tel:+5511999999999" className="text-primary-foreground/80 hover:text-primary-foreground">
                  (11) 99999-9999
                </a>
              </li>
              <li className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-primary-foreground/80 mb-4">
              Receba conteúdos exclusivos, dicas e novidades sobre comunicação corporativa.
            </p>
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Inscreva-se para receber conteúdos exclusivos, dicas práticas e informações sobre próximos eventos e palestras.
                  </DialogDescription>
                </DialogHeader>
